...
public class NormalizedLandmark {
  public static final List<String> landmark_names =
      Arrays.asList(
          ...
          "left_foot_index",
          "right_foot_index");
  private static final double torso_size_multiplier = 2.5;
  public double x;
  public double y;
  public double z;
  ...
  public static NormalizedLandmark[] convertFromMediapipe(
    ...
    for (LandmarkProto.NormalizedLandmark landmark : landmarks.getLandmarkList()) {
      NormalizedLandmark normalized =
          new NormalizedLandmark(landmark.getX(), landmark.getY(), landmark.getZ());
  ...
  public static NormalizedLandmark getAverageByNames(
      NormalizedLandmark[] landmarks, String name_from, String name_to) {
  ...
  public static double getDistanceByNames(
      NormalizedLandmark[] landmarks, String name_from, String name_to) {
    NormalizedLandmark from = landmarks[landmark_names.indexOf(name_from)];
    NormalizedLandmark to = landmarks[landmark_names.indexOf(name_to)];
