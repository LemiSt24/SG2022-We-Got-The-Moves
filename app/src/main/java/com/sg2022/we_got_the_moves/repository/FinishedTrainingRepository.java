...
public class FinishedTrainingRepository {
    ...
    public void insert(FinishedTraining finishedTraining){
        this.executors.getPoolThread().execute(() ->
                this.Dao.insert(finishedTraining));
    }

    public LiveData<List<FinishedTraining>> getNLastTrainigs(int n){return this.Dao.getNLastTrainings(n);}

    public LiveData<FinishedTraining> getLastTraining() {
        return this.Dao.getLastTraining();
    }

    public LiveData<List<Long>> getNLastDistinctWorkoutIds(int n) {return this.Dao.getNLastDistictWorkoutIds(n);}

    public LiveData<List<FinishedTraining>> getOrderedFinishedWorkouts() {return  this.Dao.getOrderedTrainings();}
