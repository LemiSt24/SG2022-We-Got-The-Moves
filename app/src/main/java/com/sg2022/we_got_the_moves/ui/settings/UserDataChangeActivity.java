...
public class UserDataChangeActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model.repository.getUser().observe(getInstanceActivity(), userData -> {
            ((TextInputEditText) findViewById(R.id.TextInputName)).setText(userData.name);
            ((TextInputEditText) findViewById(R.id.TextInputAge)).setText(Integer.toString(userData.age));
            ((TextInputEditText) findViewById(R.id.TextInputHeight)).setText(Float.toString(userData.hightInMeters));
            ((TextInputEditText) findViewById(R.id.TextInputWeight)).setText(Float.toString(userData.weigthInKg));
            if (userData.isMale){
        ...
        saveButton.setOnClickListener(v -> {
            User newUser = new User(
                    ((TextInputEditText)findViewById(R.id.TextInputName)).getText().toString(), //set Name
                    Float.valueOf(((TextInputEditText) findViewById(R.id.TextInputHeight)).getText().toString()), //set Height
                    Float.valueOf(((TextInputEditText) findViewById(R.id.TextInputWeight)).getText().toString()), //set Weight
                    findViewById(R.id.maleButton).isActivated(), //set Gender
                    Integer.valueOf(((TextInputEditText) findViewById(R.id.TextInputAge)).getText().toString()) //set Age
            );
